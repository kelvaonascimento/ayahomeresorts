...
export default function AyaHomeResortLanding() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-semibold text-gray-700">AYA Home Resort</span>
            </div>
            ...
            <CardContent className="p-6">
              <table className="w-full min-w-[800px]">
                ...
                <tbody>
                  ...
                  >
                    <td className="py-4 font-black text-orange-600">AYA Home Resort</td>
      ...
      <footer className="bg-gray-900 py-12 text-center">
        ...
        <p className="text-gray-400 text-sm">Análise Confidencial • AYA Home Resort</p>
